import { TVec3, TVec4 } from "../util/Utils";
...
export { IHeater, THeaters, IPrinterInfo, TPrinterCapabilities, IFileInfo, IHomedAxes, IPrinterLimits };
